...
MainWindowVisVar::MainWindowVisVar(CommonEngineData *engine_,QWidget *parent) :
    QMainWindow(parent),
...
//    connect(varExchange,SIGNAL(transfer_finished(int, QString)),this,SLOT(slotTransferFinished(int,QString)));
    ...
    connect(engine,                 SIGNAL(signalEventsRequest(TRequestEvent)),this,SLOT(slotIds(TRequestEvent)));
