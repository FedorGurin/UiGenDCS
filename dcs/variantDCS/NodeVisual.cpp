...
void AirTargetObject::getRequest(QString prefix,TCommonRequest *request,bool circleVariant)
{
    if(circleVariant==false)
    {
        QString prefixName = prefix + "INITDesTarget["+QString::number(index)+"].";

        request->append(prefixName+"Global_numTarget",QString::number(index));
...
void GroundTargetObject::getRequest(QString prefix,TCommonRequest *request)
{
    QString prefixName = prefix + "INITDesGRTarget["+QString::number(index)+"].";

    request->append(prefixName+"Global_numGRTarget",QString::number(index));
